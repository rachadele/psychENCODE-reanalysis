process AverageDEOverlaps {
  ...
  publishDir "${params.outdir}/de_overlap/average_overlaps/per_celltype", mode: "copy", pattern: "per_celltype_average*.tsv"
  publishDir "${params.outdir}/de_overlap/average_overlaps/overall_average", mode: "copy", pattern: "average_jaccard.tsv"
  publishDir "${params.outdir}/de_overlap/average_overlaps/figs", mode: "copy", pattern: "**png"
  input:
  path de_overlap_files
  output:
  path "filtered**.tsv"
  path "**per_celltype_average_jaccard.tsv"
  path "average_jaccard.tsv"
  path "**png"
  script:
  """
